-- B. Data manipulation Laguage
USE practice_db;
SELECT * from students;CREATE TABLE students (
...
UPDATE students SET email ="john.doe@example.com" WHERE email="john.doe1@example.com";
...
-- Update all rows
UPDATE students SET enrollment_date ='2024-11-20';
...
FROM students
WHERE enrollment_date = '2025-11-03 21:32:18';
